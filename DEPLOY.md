...
## ملاحظات مهمة
- **رفع صور المنتجات:** لا يعمل رفع الملفات على Vercel (نظام ملفات للقراءة فقط). استخدم **حقل رابط الصورة (URL)** في لوحة الإدارة، أو لاحقًا نربط تخزينًا سحابيًا (Vercel Blob / Cloudinary).
